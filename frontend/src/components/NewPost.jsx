...
function NewPost({ newPost, onClose }) {
    ...
    return (
        <div className="bg-black/40 fixed inset-0 flex items-center justify-center z-50" onClick={handleOverlayClick}>
            <div className="flex flex-col items-center justify-center">
                ...
                <button className="text-white font-semibold text-xl mt-4" onClick={onClose}>
                    Close
                </button>
